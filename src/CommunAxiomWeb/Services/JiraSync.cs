                ...
                try
                {
                    ...
                    if (DateTime.Now - this.lastFetched > new TimeSpan(0, 15, 0) || res.Jql != this.jql) {
                        ...
                        foreach(var i in issues)
                        {
                            ...
                            if(i.AdditionalFields.TryGetValue("customfield_10022", out startToken))
                            {
                            ...
                            if (i.AdditionalFields.TryGetValue("customfield_10023", out endToken))
                            {
                            ...
                            int priocode= 0;
                            if (i.AdditionalFields.TryGetValue("customfield_10029", out prioToken)){
